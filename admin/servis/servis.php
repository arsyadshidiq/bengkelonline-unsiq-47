...
<body>
	...
	<div class="container">
		...
		<p>
			<a href="cetak_dataservis.php" class="btn btn-primary">Ceta Data</a>
		</p>
		...
		<div class="row col-sm-12 col-md-6">	
			<table class="table table-bordered table-responsive table-striped">
				...
				<tbody>
					...
					<?php
						$query = ("SELECT * FROM servis ORDER BY id_cust") or die (mysql_error());
						...
						while ($data = mysqli_fetch_array($exec) ) {
							...
							<tr>
								...
								<td>
									...
									<a href="hapus_servis.php?id=<?=$data['id_cust']?>" class="btn btn-danger">Hapus</a>
